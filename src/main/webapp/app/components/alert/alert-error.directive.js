(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('smartWebApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                ...
                if (angular.isString(errorHeader)) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('smartWebApp.' + fieldError.objectName + '.' + convertedField);
